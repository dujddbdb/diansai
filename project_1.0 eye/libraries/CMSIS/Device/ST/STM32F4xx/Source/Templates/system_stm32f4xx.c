...
#if defined(STM32F40_41xxx)
/******************************************************************************/
/*  STM32F407: HSI(16MHz) + PLL => 168MHz, no external crystal needed         */
/******************************************************************************/
  ...
  /* HSI=16MHz, M=16, N=336, P=2 => VCO=336MHz, SYSCLK=168MHz */
...
#elif defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) || defined(STM32F412xG) || defined(STM32F413_423xx) || defined(STM32F446xx)|| defined(STM32F469_479xx)
/******************************************************************************/
...
/******************************************************************************/
  ...
  {
    /* HSE failed - use HSI+PLL fallback, works on all boards */
#if defined(STM32F40_41xxx)
    RCC->APB1ENR |= RCC_APB1ENR_PWREN;
    PWR->CR |= PWR_CR_VOS;
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;
